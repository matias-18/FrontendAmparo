...
@Component({
  selector: 'app-vic-detalle-sesion-pendi',
  standalone: true,
  ...
  templateUrl: './vic-detalle-sesion-pendi.component.html',
  styleUrl: './vic-detalle-sesion-pendi.component.css'
})
export class VicDetalleSesionPendiComponent implements OnInit{
  ...
  volver() {
    this.router.navigate(['/viclistarsesionpendi']);
  }
