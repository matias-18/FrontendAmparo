...
@Component({
  selector: 'app-vic-detalle-sesion-historial',
  standalone: true,
  ...
  templateUrl: './vic-detalle-sesion-historial.component.html',
  styleUrl: './vic-detalle-sesion-historial.component.css'
})
export class VicDetalleSesionHistorialComponent  implements OnInit {
  ...
  volver() {
    this.router.navigate(['/vichistorialsesionpendi']);
  }
