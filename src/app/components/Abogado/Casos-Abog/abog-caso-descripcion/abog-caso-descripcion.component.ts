...
@Component({
  selector: 'app-abog-caso-descripcion',
  standalone: true,
  imports: [CommonModule, MenuAbogComponent],
  templateUrl: './abog-caso-descripcion.component.html',
  styleUrl: './abog-caso-descripcion.component.css'
})
export class AbogCasoDescripcionComponent  implements OnInit {
  ...
  volver() {
    this.router.navigate(['/peticionesAbog']);
  }
}
