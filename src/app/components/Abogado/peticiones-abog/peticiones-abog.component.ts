...
@Component({
  ...
  templateUrl: './peticiones-abog.component.html',
  styleUrls: ['./peticiones-abog.component.css']
})
export class PeticionesAbogComponent implements OnInit {
  ...
  verDetalleCaso(id: number) {
    this.router.navigate(['/abogCasoDescripcion', id]);
  }
