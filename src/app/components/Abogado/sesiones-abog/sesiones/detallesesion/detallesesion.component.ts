...
@Component({
  ...
  templateUrl: './detallesesion.component.html',
  styleUrl: './detallesesion.component.css'
})
export class DetallesesionComponent implements OnInit{
