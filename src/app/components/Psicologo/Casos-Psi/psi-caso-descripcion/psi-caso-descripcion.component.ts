...
@Component({
  selector: 'app-psi-caso-descripcion',
  standalone: true,
  imports: [CommonModule, MenuPsicologoComponent],
  templateUrl: './psi-caso-descripcion.component.html',
  styleUrl: './psi-caso-descripcion.component.css'
})
export class PsiCasoDescripcionComponent implements OnInit {
  ...
  volver() {
    this.router.navigate(['/peticionesPsi']);
  }
