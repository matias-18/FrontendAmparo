...
@Component({
  selector: 'app-perfil-psi',
  standalone: true,
  imports: [ReactiveFormsModule, CommonModule, MenuPsicologoComponent],
  templateUrl: './perfil-psi.component.html',
  styleUrl: './perfil-psi.component.css',
  providers: [
    { provide: JWT_OPTIONS, useValue: JWT_OPTIONS },
    JwtHelperService
  ]
})
export class PerfilPsiComponent implements OnInit {
  userName: string = '';
  userForm: FormGroup;
