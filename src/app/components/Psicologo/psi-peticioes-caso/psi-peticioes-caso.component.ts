...
@Component({
  selector: 'app-psi-peticioes-caso',
  standalone: true,
  ...
  templateUrl: './psi-peticioes-caso.component.html',
  styleUrl: './psi-peticioes-caso.component.css'
})
export class PsiPeticioesCasoComponent  implements OnInit{
  ...
  verDetalleCaso(id: number) {
    this.router.navigate(['/psiMisCasoDescripcion', id]);
  }
